      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="shadow-lg lg:col-span-1">
          <CardHeader>
            ...
            <CardDescription className="text-sm">Your current check-in information.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 p-4 sm:p-6">
            ...
            <div className="flex items-center text-xs sm:text-sm text-muted-foreground pl-1 gap-1">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-2">
             ...
             <Button variant="link" className="w-full px-1 justify-start text-xs sm:text-sm text-primary hover:underline">View Full Day Log</Button>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg lg:col-span-1">
          <CardHeader>
            <CardTitle  className="text-lg sm:text-xl font-headline">Upcoming Leave</CardTitle>
             <CardDescription className="text-sm">Your approved time off.</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col h-[calc(100%-92px)] justify-between p-4 sm:p-6"> 
            {upcomingLeave ? (
            ...
            <Button variant="outline" className="w-full mt-auto text-sm sm:text-base py-2.5"> 
        ...
        <Card className="shadow-lg lg:col-span-1">
          <CardHeader>
            ...
            <CardDescription className="text-sm">Access common actions and information.</CardDescription>
          </CardHeader>
