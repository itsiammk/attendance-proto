...
import { DatePickerWithPresets } from "@/components/ui/date-picker-with-presets" // Assuming this exists
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="present" className="w-full">
        ...
        <TabsContent value="absent">
          {/* Could reuse DailyAttendanceTable with filtered data or show a "No absent staff" message */}
          <div className="p-6 border rounded-lg text-center text-muted-foreground bg-card">
            No absent staff for the selected criteria.
          </div>
        </TabsContent>
        <TabsContent value="half-day">
          {/* Could reuse DailyAttendanceTable with filtered data or show a "No half-day staff" message */}
           <div className="p-6 border rounded-lg text-center text-muted-foreground bg-card">
